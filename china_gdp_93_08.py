...
# 	  ("山西",3571.21),("福建",3552),("重庆",2884),("贵州",3476.65),("吉林",2746.22),
# 	  ("甘肃",2557.53),("内蒙古",2470.63),("上海",2301.391),("台湾",2316.2),
# 	  ("新疆",2181.33),("北京",1961.2),("天津",1293.82),("海南",867.15),
# 	  ("香港",709.76),("青海",562.67),("宁夏",630.14),("西藏",300.21),("澳门",55.23)]
#
# map=Map()
# map.add("",data,"china")
# map.set_global_opts(
